...
OpenBao is automatically deployed with this example. If you already have a deployed OpenBao instance, this script will skip the installation.
...
- All components described in this [section](/showcases/openbao.md)
- Key/Value Store is configured on OpenBao server
...
There could be some problems with existing filehandles, for example on the rootCA, installed into OpenBao. In this case please drop the namespaces and try again:
