...
echo "  curl --cacert ../openbao/root-certs/bundle.pem \\"
...
echo "    -v \"\$(pwd)/../openbao/root-certs/bundle.pem:/bundle.pem:ro\" \\"
...
echo "  kubectl port-forward -n kong svc/kong-gateway-proxy 5432:9443 &"
echo "  psql \"host=postgres.example.com port=5432 sslmode=require sslnegotiation=direct user=demo password=demo dbname=demo sslrootcert=../openbao/root-certs/bundle.pem\""
